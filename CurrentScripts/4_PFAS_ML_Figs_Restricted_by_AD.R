...
load(file=paste0("Tox21_AllMods_ADindicate_", suff,".RData"))
...
write.csv(DPFASwAD, file=paste0("All_DSSTox_Predictions_With_Domains_",writesuff,".csv"))
...
write.csv(allchems, file=paste0("AllChemicals_in_CatMod_Domain_",writesuff,".csv"))
